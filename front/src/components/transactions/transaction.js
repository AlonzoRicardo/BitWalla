...
class Transaction extends Component {
  constructor(props) {
    super(props);
    this.state = { from: '', to: 'mkbb96pB6onaFX4Adgoup5e8AUFT4M8cmB', amount: 0, balance: 0, fees: 0, redirect: false, error: true};
      ...
      {/* !this.state.error && this.renderRedirect() */}
        ...
        <div className="form-group">
         ...
         <div className="form-group">
          ...
          <small id="emailHelp" className="form-text text-muted">The higher, the faster.</small>
        </div>
        

        <input type="submit" className="btn btn-primary"  onClick={this.sendTransaction}/>
